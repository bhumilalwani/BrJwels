...
const Awards = () => {
  return (
    <div className='w-[100%] h-[20vh] flex flex-col items-center justify-center gap-[10vh] mt-[10vh]'>
    <h2 className='text-center text-black text-xl mt-[2vh] font-semibold'>Awards & Accolades</h2>
